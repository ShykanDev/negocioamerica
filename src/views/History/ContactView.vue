<template>
 <MainLayout>
    <template #main>
        <section class="p-6 mx-auto mt-10 overflow-hidden bg-white rounded-lg shadow-md max-w-7xl font-poppins">
   <h1 class="text-4xl font-bold text-center text-sky-800">
    Contáctenos
   </h1>
   ...
   <div class="grid grid-cols-1 gap-8 mt-8 md:grid-cols-2">
    <div>
     ...
     <div class="grid grid-cols-1 gap-4">
      <div class="flex items-center p-4 bg-gray-100 rounded-lg shadow-md animate-fade-right">
      ...
      <div class="flex items-center p-4 bg-gray-100 rounded-lg shadow-md animate-fade-up">
    ...
    <div>
     ...
     <iframe allowfullscreen="true" class="w-full h-64 mt-4 rounded-lg shadow-md animate-fade-up" loading="lazy" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3763.315073073073!2d-99.1760456846826!3d19.43260798688856!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85d1ff3e1b1b1b1b%3A0x1b1b1b1b1b1b1b1b!2sGutenberg%20%23128%2C%20Anzures%2C%20Miguel%20Hidalgo%2C%2011590%20Ciudad%20de%20M%C3%A9xico%2C%20CDMX%2C%20Mexico!5e0!3m2!1sen!2sus!4v1633021234567!5m2!1sen!2sus">
     </iframe>
    </div>
   </div>
  </section>
